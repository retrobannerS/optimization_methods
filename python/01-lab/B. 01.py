...
ax.plot(X, line1, label=r"$x_2 = \frac{1}{3}x_1 - \frac{2}{3}$")
ax.plot(X, line2, label=r"$x_2 = -x_1 + 10$")
ax.plot(line3, X, label=r"$x_1 = 0$")
ax.plot(X, line4, label=r"$x_2 = 0$")
ax.fill_between(
    X, line1, 20, color="blue", alpha=0.2, label=r"Область $x_2 \geq \frac{1}{3}x_1 - \frac{2}{3}$"
)
ax.fill_between(
    X,
    line2,
    ...
    color="red",
    alpha=0.2,
    label=r"Область $x_2 \geq -x_1 + 10$",
)
